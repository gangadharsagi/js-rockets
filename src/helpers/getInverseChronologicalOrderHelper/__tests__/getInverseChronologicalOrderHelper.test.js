import { getInverseChronologicalOrderHelper } from '../getInverseChronologicalOrderHelper';
import { getFormattedDataHelper } from '../../getFormattedDataHelper';

describe('getInverseChronologicalOrderHelper', () => {
  it('should return nasa customer with flight_number mission name and payloads_count ', () => {
    const mockData = [
      {
        flight_number: 1,
    ...
    const expected = getInverseChronologicalOrderHelper(mockData);
    const result = [
      {
        flight_number: 2,
        mission_name: 'DemoSat',
  ...
  it('should return default value', () => {
    ...
    const expected = getFormattedDataHelper(mockData);
    const result = [];
    expect(expected).toEqual(result);
  });
});
